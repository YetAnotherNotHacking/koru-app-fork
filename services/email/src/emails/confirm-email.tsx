...
export default function ConfirmEmail({
  ...
  return (
    <Html>
      <Head />
      <Preview>Confirm your email address for Koru App</Preview>
        ...
        <Body className="bg-[#0D0D0D] m-auto p-5 font-sans">
          <Container className="mx-auto bg-[#121212] border border-[#333333] rounded-lg w-full max-w-[600px] overflow-hidden">
            ...
            <Section className="p-6 bg-black border-b border-[#333333]">
              <Text className="text-white text-2xl font-bold">Koru App</Text>
            </Section>
            ...
            <Section className="p-8">
              ...
              <Text className="text-base leading-6 text-[#D1D1D1] my-4">
                Hey <span className="text-white font-semibold">{name}</span>,
              </Text>
              <Text className="text-base leading-6 text-[#D1D1D1] my-4">
                Thanks for joining us! Please confirm your email address to
              ...
              <Section className="mt-8 p-4 bg-[#1A1A1A] rounded-md border border-[#333333]">
                <Text className="text-xs leading-5 text-[#999999] m-0">
                  This is an automated message from Koru App. Please do not
                  reply to this email. For security reasons, we'll never ask for
            ...
            <Section className="bg-black p-6 border-t border-[#333333] text-center">
              <Text className="text-xs leading-5 text-[#999999] m-0">
                © {new Date().getFullYear()} Koru App. All rights reserved.
              </Text>
            </Section>
          </Container>
        </Body>
